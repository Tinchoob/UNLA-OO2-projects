...
public class Cuota {
	...
	public Cuota() {}	// constructor vacio
	
	
	public Cuota(int nroCuota,LocalDate fechaVencimiento,double saldoPendiente, double amortizacion,double interesCuota,double cuota, double deuda,Prestamo prestamo) {
	...
	public String toString() {
		return "Cuota [idCuota "+idCuota+"nroCuota=" + nroCuota + ", fechaVencimiento=" + Funciones.traerFechaCorta(fechaVencimiento) + ", saldoPendiente="
